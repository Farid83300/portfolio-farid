                        ...
                        <div className="col-lg-6 order-lg-1">
                            <div className="inner">
                                ...
                                <p className="disc tmp-scroll-trigger tmp-fade-in animation-order-3">
                                    Freelance basé en France à Draguignan, je développe des
                                    applications web full-stack pour des clients qui veulent un
                                    interlocuteur unique, un code maintenable, et un projet livré
