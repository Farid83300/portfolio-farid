            ...
            <div className="about-us-right-content-wrap">
                <div className="section-head text-align-left mb--50">
                    ...
                    <p className="description tmp-scroll-trigger tmp-fade-in animation-order-3">
                        Hello! I'm Fatima, a passionate your profession, e.g., Web Developer,
                        Graphic Designer, Data Analyst based in Dhaka. With a strong focus on
                        creativity, innovation, and a commitment to continuous learning, I bring a
                        unique blend of technical skills and artistic vision to each project I
                        undertake.
                    </p>
                </div>
