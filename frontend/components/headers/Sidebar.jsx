                ...
                <div className="inner">
                    ...
                    <div className="content-wrapper">
                        ...
                        <h5 className="title mt--30">
                            Freelance proposant des solutions PHP/React et WordPress
                            exceptionnelles.
                        </h5>
                        <p className="disc">
                            Je suis un développeur freelance expérimenté, spécialisé dans le
                            développement PHP/React, la conception Figma et les projets WordPress.
                            Je propose des solutions web créatives, dynamiques et centrées sur
                            l'utilisateur.
                        </p>
