...
export const metadata = {
  title: 'Home 19 || Personal Portfolio React Nextjs Template | Freelancer & Developer Portfolio',
  description: 'Personal Portfolio React Nextjs Template | Freelancer & Developer Portfolio',
};
export default function page() {
  return (
    <>
      <BodyClassToggler classes={['spybody', 'color-blue', 'box-body', 'tmp-white-version']} />
      <Header2
